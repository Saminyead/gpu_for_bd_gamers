...
To give an example of how it works, the Base Tier Score of the GTX 1660 Ti is 2.15. That means, the GTX 1660 Ti will have 2.15 times higher average FPS across a variety of 
...
Following the page for the <a href="https://www.techpowerup.com/gpu-specs/geforce-gtx-1050-ti.c2885">GTX 1050 Ti</a>, a bar graph can be found that indicates the  relative
performances of the graphics cards with a percentage point. This is the relative performance of the cards compared to the GTX 1050 Ti. For example, the GTX 1660 Ti has 215% — meaning
...
Tier Score Multiplier. This is then multiplied with the Base Tier Score to obtain the Overall Additional Score. This Overall Additional Score is then added to the Base Tier Score 
...
1650. Examples of the notable negative traits include the persistent driver issues of the Intel Arc GPU's (though Intel has made a lot of improvements, and they said they would improve
...
to pay a higher (or lower for a negative trait) amount of money for a GPU having that trait compared to a GPU with similar specifications but without that trait. For example,
...
A list of these special positive and negative traits and their weight scores can be found in the 'comment_table' sheet of the <a href="https://github.com/Saminyead/gpu_for_bd_gamers/blob/master/tier_score.xlsx">tier_score.xlsx</a> Excel file in the homepage of this repository. The comment_code column contains a short-hand code for each of the positive and negative traits. The comment_desc column contains a description for
